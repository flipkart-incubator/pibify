 ...
 * Date 31/10/24
 */
public class ClassWithJsonCreatorWithSettersAndEmptyConstructor {
    ...
    public ClassWithJsonCreatorWithSettersAndEmptyConstructor() {
    }

    @JsonCreator
    public ClassWithJsonCreatorWithSettersAndEmptyConstructor(@JsonProperty("bigDecimal") BigDecimal bigDecimal,
    ...
    public static ClassWithJsonCreatorWithSettersAndEmptyConstructor randomize() {
        Map<BigDecimal, Double> map = new HashMap<>();
        map.put(BigDecimal.valueOf(Math.random()), Math.random());
        map.put(BigDecimal.valueOf(Math.random()), Math.random());
        map.put(BigDecimal.valueOf(Math.random()), Math.random());
        return new ClassWithJsonCreatorWithSettersAndEmptyConstructor(BigDecimal.valueOf(Math.random()),
                Math.random(),
                "str" + Math.random(),
                map,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ClassWithJsonCreatorWithSettersAndEmptyConstructor)) return false;
        ClassWithJsonCreatorWithSettersAndEmptyConstructor that = (ClassWithJsonCreatorWithSettersAndEmptyConstructor) o;
